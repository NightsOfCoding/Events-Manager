...
import { setEvents, setLoggeduserEmail, getUserEvents } from "../stores/sessionSlice";
                ...
                <Row>
                    <Form.Group as={Row}>
                        <div className="acceptTermsWrapper">
                            <Form.Check type="checkbox" name="t&c" onClick={(e)=>dispatch(setEventTc(e.target.checked))}/><Form.Label column>Accept Terms & Conditions</Form.Label>
                        </div>
                    </Form.Group>
                </Row>
                <Row>
